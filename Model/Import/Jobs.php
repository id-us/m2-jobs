<?php
namespace Idus\Jobs\Model\Import;

use Idus\Jobs\Model\Import\Jobs\RowValidatorInterface as ValidatorInterface;
use Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregatorInterface;
use Magento\Framework\App\ResourceConnection;
use Magento\ImportExport\Model\Import as ImportExport;

class Jobs extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
    const TITLE = 'title';
    const CODE = 'code';
    const STOTRE = 'store';

    const TABLE_Entity = 'idus_jobs';
     ...
     * @array
     */
    protected $validColumnNames = [self::CODE,self::STOTRE];
        ...
        if ($entityData) {
            ...
            if ($entityIn) {
                ...
                if(isset($data[self::CODE])){                
                    $this->_connection->insertOnDuplicate($tableName, $entityIn, array_keys(reset($entityIn)));
                }else{
                    $this->_connection->insertOnDuplicate($tableName, $entityIn, array_keys(reset($entityIn)));
                }
            }
